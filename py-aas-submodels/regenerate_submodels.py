...
AAS_SM_TO_PY_PATH = REPO_ROOT / "aas-sm-to-py"
if str(AAS_SM_TO_PY_PATH) not in sys.path:
    sys.path.insert(0, str(AAS_SM_TO_PY_PATH))

from aas_sm_to_py.generator import SubmodelCodegen  # noqa: E402
